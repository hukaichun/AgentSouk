...
from funduq_provider_sdk import ProviderIdentity, deletion_payload, registration_payload


def test_a_registration_payload_is_exactly_these_bytes():
    assert registration_payload(["translator"], 1755300000) == b"funduq-register:translator:1755300000"
...
def test_a_deletion_payload_is_exactly_these_bytes():
    assert deletion_payload("translator", 1755300000) == b"funduq-delete-agent:translator:1755300000"
