...
class DeliveredCompletion(BaseModel):
    ...
    OpenAI-shaped completion-create object relayed as-is — souk is a relay,
    ...
    def from_request(cls, request: Any) -> "DeliveredCompletion":
        """Translates souk's completion-request object (read by attribute, never imported) into the delivered form."""
        return cls(
