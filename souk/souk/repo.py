...
handfuls of tables and simple queries don't need a full ORM for v1 (see
souk/alembic/ for the schema itself, hand-written DDL applied via
`alembic upgrade head`, not autogenerated from any model here).
"""
